...
Rails.application.configure do
  ...
  # Allow serving of assets from subdomains
  config.action_dispatch.tld_length = 1 # For .lvh.me (or 2 for .co.uk)
  # config.hosts << "lvh.me"
  # config.hosts << ".lvh.me"  # This will allow all subdomains of lvh.me
